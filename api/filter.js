...
module.exports = async (req, res) => {
    ...
    // Memeriksa apakah parameter 'type' telah diberikan
if (!req.query.categori) {
    res.status(400).json({ error: 'Parameter kategori tidak ditemukan contoh / action, box-office' });
    return;
}

    const categori = req.query.categori;
    const url1 = `${targetUrl}category/${categori}/`;
    const url2 = `${targetUrl}category/${categori}/page/2/`;
