...
module.exports = async (req, res) => {
    ...
    if (!id) {
        res.status(400).json({ error: 'Parameter fitur id movie or tvseries tidak ditemukan' });
        return;
    }
    ...
    https.get(url, (response) => {
        ...
        response.on('end', () => {
            ...
            const articles = document.querySelectorAll('div[class="items featured"] article');
            let results = [];
